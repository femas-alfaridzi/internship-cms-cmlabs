      ...
      <main className="flex-1 overflow-auto p-8">
        <header className={`${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} border-b px-8 py-4 flex items-center justify-between transition-colors`}>
          <div className="flex items-center gap-4">
            ...
            <div className="text-sm"><span className={isDark ? 'text-gray-400' : 'text-gray-500'}>Pages / </span><span className={`${isDark ? 'text-blue-400' : 'text-blue-600'} font-medium`}>Setting Organization</span></div>
          </div>
          <div className="flex items-center gap-4">
        ...
        <div className="p-8">
          <h1 className="text-3xl font-bold mb-4">Setting Organization</h1>
          <p className="text-sm text-gray-600">This is a placeholder page for Setting Organization. Replace with real content as needed.</p>
        </div>
      </main>
    </div>
  );
